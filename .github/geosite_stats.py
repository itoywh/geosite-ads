...
def main():
    ...
    SOURCES = (
        ...
        ("CATEGORY-ADS-AWAVENUE", "awavenue"),
    )
    for path in sys.argv[1:]:
        ...
        print("- `category-ads-awavenue`: AWAvenueAdsRule subset (advertising + privacy scope).")
        print("- `category-ads-all` = union of official + awavenue; count is not the sum of the two above because overlapping domains are absorbed.")
    return 0
